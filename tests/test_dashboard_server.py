...
class DashboardTests(unittest.TestCase):
    ...
    def test_airflow_theme_and_afterheat_contract(self):
        ...
        self.assertIn('x="674" y="312" text-anchor="end">FØR EFTERVARME</text>', html)
        self.assertIn('x="674" y="336" text-anchor="end" id="before-coil-value"', html)
        self.assertIn('x="34" y="336" id="left-bottom-value"', html)
        self.assertIn('x="846" y="336" text-anchor="end" id="right-bottom-value"', html)

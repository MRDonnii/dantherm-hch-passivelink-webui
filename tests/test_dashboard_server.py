...
class DashboardTests(unittest.TestCase):
    ...
    def test_webui_v2_airflow_and_navigation_contract(self):
        ...
        self.assertLess(overview.index("UDELUFT"), overview.index("AFKAST"))
        self.assertIn("HCH5 varmegenvinding", overview)
        self.assertIn("bypass faktisk lukket", overview.lower())
        self.assertIn('to="/technique"', shell)
        self.assertIn('to="/updates"', shell)

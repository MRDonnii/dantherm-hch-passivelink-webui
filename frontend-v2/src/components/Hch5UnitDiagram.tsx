...
function Rs485Wiring({ active }: { active: boolean }) {
  ...
  return <g className={`hch-wiring${active ? " active" : ""}`}>
    ...
    <g className="hch-device hch-hac1-box"><rect className="device-body" x="-28" y="474" width="170" height="52" rx="10"/><text x="57" y="496" textAnchor="middle">HAC1 styring</text><text className="device-sub" x="57" y="515" textAnchor="middle">Modbus-slave 0x40</text></g>
